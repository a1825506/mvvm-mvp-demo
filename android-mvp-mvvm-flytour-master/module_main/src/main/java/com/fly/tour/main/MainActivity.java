...
public class MainActivity extends BaseActivity {
    ...
    @Autowired(name = "/discuz/main")
    IDiscuzProvider mDiscuzProvider;

    private Fragment mNewsFragment;
    private Fragment mMeFragment;
    private Fragment mDiscuzFragment;
    ...
    public void initView() {
        ...
        navigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (i == R.id.navigation_trip) {
                    ...
                    switchContent(mCurrFragment, mDiscuzFragment, MainChannel.DISCUZ.name);
                    mCurrFragment = mDiscuzFragment;
        ...
        if(mNewsProvider != null){
            mNewsFragment = mNewsProvider.getNewsListFragment();
        }

        if(mMeProvider != null){
            mMeFragment = mMeProvider.getMainMeFragment();
        }
        if(mDiscuzProvider != null){
            mDiscuzFragment = mDiscuzProvider.getDiscuzFragment();
        }
        mCurrFragment = mNewsFragment;
